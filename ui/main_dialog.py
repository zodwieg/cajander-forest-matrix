...
class MainBiomeDialog(QDialog):
    ...
    def _on_tab_changed(self, index):
        """Скрывает главную кнопку выполнения, если мы ушли на вкладку подготовки данных"""
    ...
    def set_loading_state(self, is_loading: bool):
        """Универсальный блокировщик UI для тяжелых фоновых задач"""
        self.tabs.setEnabled(not is_loading)
